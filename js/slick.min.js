...
;(function(factory) {
    ...
    Slick.prototype.moveSliders = function(cssData) {
        var windowWidth = window.innerWidth;
        if (windowWidth < 1380 && windowWidth > 1023) {
            if(this.$slider.hasClass('js-slider-top')) {
            $('.js-slider-bottom .slick-track').css(cssData);
         }

         if(this.$slider.hasClass('js-slider-bottom')) {
            $('.js-slider-top .slick-track').css(cssData);
         }
        } 
    }
    ...
    Slick.prototype.getDotCount = function() {
        ...
        if (_.options.infinite === true) {
           ...
           // pagerQty = 1+(Math.round(w / $(_.$list).width() )); 
            
           // console.log(w);
          //  console.log($(_.$list).width());
            
            //pagerQty = 1 + Math.ceil((_.slideCount - _.options.slidesToShow) / _.options.slidesToScroll);
            
            var q = (w / $(_.$list).width() );
            if (q < 3.3) {
                pagerQty  = _.slideCount - 1;    
            } else {
                pagerQty  = _.slideCount;
            }
            //console.log(q);
